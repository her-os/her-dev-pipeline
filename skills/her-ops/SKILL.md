...
| 17 | 网关 CVM 出口 IP ≠ 公网 IP | 入站 192.144.187.174，出站 81.70.184.21（2026-06-09 起，疑 K8s 迁移期 VPC 变更）。凡按 IP 白名单放行 gateway 的外部服务需放行两个 IP；排查上游 403 先在 CVM 跑 `curl ifconfig.me` 确认当前出口。bwg-la relay 三反代已修（2026-06-12） |
