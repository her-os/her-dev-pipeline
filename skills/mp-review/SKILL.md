---
name: mp-review
description: "Review changes since a fixed point (commit, branch, tag) along two axes — Standards (does code follow repo conventions?) and Spec (does code match the originating issue/PRD?). Runs both reviews in parallel sub-agents. Use when user wants to review a branch, PR, WIP changes, or says 'review since X'."
---
